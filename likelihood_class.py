...
class Likelihood_bird(Likelihood_eft):
    ...
    def __init__(self, path, data, command_line):
        ...
        self.projection = pb.Projection(self.k, self.Om_AP, self.zAP, nbinsmu=200, Qll=self.Qll, k_or=self.setk_or, kp_or=self.setkp_or, binning=self.binning, fibcol=self.fibcol_window, co=self.co)
