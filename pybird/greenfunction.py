...
class GreenFunction(object):
    def __init__(self, Omega0_m, w=None, quintessence=False, Omega0_k=0.0):
        self.Omega0_m = Omega0_m
        self.OmegaL_by_Omega_m = (1.0 - self.Omega0_m - Omega0_k) / self.Omega0_m
        self.wcdm = False
    ...
    def Y(self, a):
        if self.quintessence:
            return -3 / 14.0 * self.G(a) ** 2 + self.mV11d(a) + self.mV12d(a)
        else:
