...
Q100 = {
    ...
    15: lambda f: 0,
    16: lambda f: 0,
    17: lambda f: (-15 + 2*f**2 - 3*f**4)/180.,
    18: lambda f: (105 - 35*f**2 - 18*f**3 + 12*f**4)/630.,
    19: lambda f: 0,
    20: lambda f: (105 + 70*f + 21*f**2 - 36*f**3 + 3*f**4 + 30*f**5 + 15*f**6)/2520.,
    21: lambda f: (-105 - 70*f + 72*f**3 + 35*f**4 - 10*f**5 - 10*f**6)/1260.,
    22: lambda f: 0,
    23: lambda f: (-315 - 420*f - 420*f**2 - 36*f**3 + 182*f**4 + 20*f**5 - 180*f**6 - 140*f**7 - 35*f**8)/30240.,
    24: lambda f: (3465 + 4620*f + 3927*f**2 - 1386*f**3 - 4873*f**4 - 3040*f**5 + 225*f**6 + 910*f**7 + 280*f**8)/166320.,
    25: lambda f: 0,
    26: lambda f: (3465 + 6930*f + 11319*f**2 + 8712*f**3 + 330*f**4 - 4580*f**5 - 930*f**6 + 4200*f**7 + 4445*f**8 + 1890*f**9 + 315*f**10)/1.99584e6,
    27: lambda f: (-45045 - 90090*f - 138138*f**2 - 82368*f**3 + 62634*f**4 + 154700*f**5 + 105600*f**6 + 8400*f**7 - 29645*f**8 - 17010*f**9 - 3150*f**10)/1.297296e7,
    28: lambda f: 0,
    29: lambda f: (-693 - 1848*f - 4158*f**2 - 5544*f**3 - 2607*f**4 + 2608*f**5 + 2724*f**6 - 1512*f**7 - 3094*f**8 - 1512*f**9 - 252*f**10)/3.193344e6,
    30: lambda f: (45045 + 120120*f + 261261*f**2 + 321750*f**3 + 64350*f**4 - 364520*f**5 - 422790*f**6 - 104580*f**7 + 96740*f**8 + 68040*f**9 + 12600*f**10)/1.0378368e8,
    31: lambda f: 0,
    32: lambda f: (3465 + 11550*f + 33033*f**2 + 61380*f**3 + 42053*f**4 - 26550*f**5 - 41475*f**6 + 11200*f**7 + 36750*f**8 + 18900*f**9 + 3150*f**10)/1.596672e8,
    33: lambda f: (-45045 - 150150*f - 420420*f**2 - 751608*f**3 - 394823*f**4 + 692250*f**5 + 1050150*f**6 + 320600*f**7 - 223650*f**8 - 170100*f**9 - 31500*f**10)/1.0378368e9,
    34: lambda f: 0,
    35: lambda f: 0,
    36: lambda f: 0,
    37: lambda f: 0,
...
Q102 = {
    ...
    15: lambda f: 0,
    16: lambda f: 0,
    17: lambda f: (f*(-350 - 159*f + 36*f**2 + 84*f**3))/12600.,
    18: lambda f: (f*(-98 + 273*f + 72*f**2 - 132*f**3))/8820.,
    19: lambda f: (f*(490 - 259*f - 124*f**2 + 64*f**3))/29400.,
    ...
    23: lambda f: (f*(-16170 - 36861*f - 46596*f**2 - 27034*f**3 + 1370*f**4 + 12675*f**5 + 7420*f**6 + 1540*f**7))/3.3264e6,
    24: lambda f: -(f*(35574 + 45969*f + 11352*f**2 - 26882*f**3 - 18950*f**4 + 6585*f**5 + 10640*f**6 + 3080*f**7))/2.32848e6,
    25: lambda f: (f*(210210 + 249249*f + 26884*f**2 - 218634*f**3 - 171330*f**4 - 5575*f**5 + 42420*f**6 + 13440*f**7))/3.36336e7,
    26: lambda f: (f*(60060 + 190476*f + 353496*f**2 + 389129*f**3 + 228510*f**4 + 4035*f**5 - 103460*f**6 - 80745*f**7 - 28350*f**8 - 4095*f**9))/6.48648e7,
    27: lambda f: (f*(336336 + 747747*f + 779064*f**2 + 189046*f**3 - 385020*f**4 - 339960*f**5 + 27440*f**6 + 174930*f**7 + 94500*f**8 + 17325*f**9))/9.081072e7,
    28: lambda f: -(f*(210210 + 429429*f + 367224*f**2 - 95069*f**3 - 472210*f**4 - 376125*f**5 - 57820*f**6 + 86485*f**7 + 54180*f**8 + 10080*f**9))/1.513512e8,
    29: lambda f: (f*(-54054 - 219219*f - 533676*f**2 - 810784*f**3 - 697692*f**4 - 190050*f**5 + 215320*f**6 + 234360*f**7 + 90720*f**8 + 13104*f**9))/4.1513472e8,
    30: lambda f: -(f*(882882 + 2753751*f + 4650360*f**2 + 3199040*f**3 - 1327500*f**4 - 3044550*f**5 - 610400*f**6 + 1159200*f**7 + 756000*f**8 + 138600*f**9))/1.45297152e9,
    31: lambda f: (f*(210210 + 609609*f + 907764*f**2 + 328796*f**3 - 870572*f**4 - 1153578*f**5 - 337736*f**6 + 228368*f**7 + 173376*f**8 + 32256*f**9))/9.6864768e8,
    32: lambda f: (f*(150150 + 740883*f + 2227368*f**2 + 4153617*f**3 + 4233500*f**4 + 1535400*f**5 - 1104600*f**6 - 1414700*f**7 - 567000*f**8 - 81900*f**9))/1.0378368e10,
    33: lambda f: (f*(546546 + 2186184*f + 5012436*f**2 + 4609059*f**3 - 871900*f**4 - 3901725*f**5 - 1108800*f**6 + 1348900*f**7 + 945000*f**8 + 173250*f**9))/7.2648576e9,
    34: lambda f: -(f*(630630 + 2369367*f + 4945512*f**2 + 3209843*f**3 - 4082000*f**4 - 7074450*f**5 - 2429000*f**6 + 1326500*f**7 + 1083600*f**8 + 201600*f**9))/2.4216192e10,
    35: lambda f: (f*(182 + 19*f - 36*f**2))/840.,
    36: lambda f: (f*(-182 - 175*f - 40*f**2 + 41*f**3 + 20*f**4))/840.,
    37: lambda f: (f*(6006 + 10923*f + 9548*f**2 + 2514*f**3 - 2070*f**4 - 1805*f**5 - 420*f**6))/73920.,
    38: lambda f: (f*(-78078 - 208923*f - 305448*f**2 - 245453*f**3 - 73810*f**4 + 49395*f**5 + 59780*f**6 + 24325*f**7 + 3780*f**8))/4.32432e6,
    39: lambda f: (f*(78078 + 275847*f + 561132*f**2 + 639652*f**3 + 319340*f**4 - 73590*f**5 - 171640*f**6 - 77840*f**7 - 12096*f**8))/2.7675648e7,
    40: lambda f: (f*(-234234 - 1028313*f - 2673528*f**2 - 3664765*f**3 - 2154800*f**4 + 283950*f**5 + 1031800*f**6 + 486500*f**7 + 75600*f**8))/6.918912e8,
    41: lambda f: (f*(78078 + 409695*f + 1295580*f**2 + 1993966*f**3 + 1274270*f**4 - 111975*f**5 - 577900*f**6 - 278000*f**7 - 43200*f**8))/2.3721984e9,
    42: lambda f: 0,
}
Q120 = {
    0: lambda f: 0,
    ...
    15: lambda f: 0,
    16: lambda f: 0,
    17: lambda f: (5*f**2 - 3*f**4)/63.,
    18: lambda f: (f**2*(-23 - 6*f + 9*f**2))/126.,
    19: lambda f: 0,
    20: lambda f: (f*(14 - 3*f - 16*f**2 - 2*f**3 + 10*f**4 + 5*f**5))/252.,
    21: lambda f: (f*(-308 + 99*f + 484*f**2 + 210*f**3 - 120*f**4 - 85*f**5))/2772.,
    22: lambda f: 0,
    23: lambda f: -(f*(231 + 231*f - 66*f**2 - 263*f**3 - 65*f**4 + 165*f**5 + 140*f**6 + 35*f**7))/8316.,
    24: lambda f: (f*(24024 + 22737*f - 14586*f**2 - 42913*f**3 - 24340*f**4 + 5415*f**5 + 10150*f**6 + 2905*f**7))/432432.,
    25: lambda f: 0,
    26: lambda f: (f*(18018 + 35607*f + 27456*f**2 - 10140*f**3 - 31420*f**4 - 10470*f**5 + 18480*f**6 + 21700*f**7 + 9450*f**8 + 1575*f**9))/2.594592e6,
    27: lambda f: -(f*(36036 + 69927*f + 44616*f**2 - 48828*f**3 - 109760*f**4 - 71142*f**5 + 1176*f**6 + 26852*f**7 + 14364*f**8 + 2583*f**9))/2.594592e6,
    28: lambda f: 0,
    29: lambda f: -(f*(12012 + 34749*f + 51480*f**2 + 17745*f**3 - 44120*f**4 - 42390*f**5 + 15120*f**6 + 37940*f**7 + 18900*f**8 + 3150*f**9))/1.0378368e7,
    30: lambda f: (f*(48048 + 137709*f + 193050*f**2 + 25545*f**3 - 274280*f**4 - 303798*f**5 - 56196*f**6 + 89978*f**7 + 57456*f**8 + 10332*f**9))/2.0756736e7,
    31: lambda f: 0,
    32: lambda f: (f*(30030 + 113685*f + 240240*f**2 + 148954*f**3 - 182250*f**4 - 244125*f**5 + 39200*f**6 + 180600*f**7 + 94500*f**8 + 15750*f**9))/2.0756736e8,
    33: lambda f: -(f*(60060 + 226083*f + 465036*f**2 + 231686*f**3 - 540600*f**4 - 769995*f**5 - 191240*f**6 + 210420*f**7 + 143640*f**8 + 25830*f**9))/2.0756736e8,
    34: lambda f: 0,
    35: lambda f: 0,
    36: lambda f: 0,
    37: lambda f: 0,
...
Q122 = {
    ...
    15: lambda f: 0,
    16: lambda f: 0,
    17: lambda f: (-105 - 226*f - 159*f**2 + 84*f**3 + 96*f**4)/5040.,
    18: lambda f: (-735 - 154*f + 381*f**2 + 108*f**3 - 198*f**4)/3528.,
    19: lambda f: (8085 + 154*f - 6589*f**2 - 2116*f**3 + 2176*f**4)/129360.,
    ...
    23: lambda f: (-45045 - 191334*f - 532389*f**2 - 696072*f**3 - 395423*f**4 + 84250*f**5 + 260265*f**6 + 145460*f**7 + 29120*f**8)/1.729728e7,
    24: lambda f: (-315315 - 726726*f - 923637*f**2 - 183144*f**3 + 601429*f**4 + 426490*f**5 - 125655*f**6 - 220780*f**7 - 63910*f**8)/1.2108096e7,
    25: lambda f: (105105 + 222222*f + 228657*f**2 - 128024*f**3 - 418221*f**4 - 254130*f**5 + 39035*f**6 + 93660*f**7 + 26880*f**8)/1.345344e7,
    26: lambda f: (45045 + 238524*f + 880308*f**2 + 1729416*f**3 + 1971574*f**4 + 1114560*f**5 - 123660*f**6 - 697480*f**7 - 515235*f**8 - 177660*f**9 - 25200*f**10)/1.0378368e8,
    27: lambda f: (315315 + 1057056*f + 2277990*f**2 + 2315352*f**3 + 435778*f**4 - 1403208*f**5 - 1214280*f**6 + 43400*f**7 + 563955*f**8 + 309960*f**9 + 56826*f**10)/7.2648576e7,
    28: lambda f: (-5360355 - 16948932*f - 33460284*f**2 - 21306168*f**3 + 25728038*f**4 + 58153600*f**5 + 38865780*f**6 + 702520*f**7 - 13471675*f**8 - 7334460*f**9 - 1310400*f**10)/4.11675264e9,
    29: lambda f: (-45045 - 285714*f - 1305447*f**2 - 3384420*f**3 - 5340130*f**4 - 4561260*f**5 - 929670*f**6 + 1917160*f**7 + 1886220*f**8 + 710640*f**9 + 100800*f**10)/8.3026944e8,
    30: lambda f: (-315315 - 1387386*f - 4172883*f**2 - 7030140*f**3 - 4683460*f**4 + 2629572*f**5 + 5319330*f**6 + 1151080*f**7 - 1872360*f**8 - 1239840*f**9 - 227304*f**10)/5.81188608e8,
    31: lambda f: (5360355 + 22564542*f + 64448241*f**2 + 90446460*f**3 + 6178990*f**4 - 147355660*f**5 - 161728470*f**6 - 31470040*f**7 + 45661420*f**8 + 29337840*f**9 + 5241600*f**10)/3.293402112e10,
    32: lambda f: (45045 + 332904*f + 1807806*f**2 + 5793684*f**3 + 11166471*f**4 + 11321300*f**5 + 3453900*f**6 - 4065600*f**7 - 4569950*f**8 - 1776600*f**9 - 252000*f**10)/8.3026944e9,
    33: lambda f: (315315 + 1717716*f + 6608316*f**2 + 15255708*f**3 + 13859277*f**4 - 3911080*f**5 - 13561950*f**6 - 3981600*f**7 + 4361350*f**8 + 3099600*f**9 + 568260*f**10)/5.81188608e9,
    34: lambda f: (-5360355 - 28180152*f - 104625378*f**2 - 216671052*f**3 - 98127553*f**4 + 294217300*f**5 + 407175900*f**6 + 102558400*f**7 - 107299150*f**8 - 73344600*f**9 - 13104000*f**10)/3.293402112e11,
    35: lambda f: (273 + 178*f - 25*f**2 - 84*f**3)/336.,
    36: lambda f: (-3003 - 5104*f - 4598*f**2 - 20*f**3 + 1993*f**4 + 820*f**5)/7392.,
    37: lambda f: (39039 + 107250*f + 190047*f**2 + 151736*f**3 + 17373*f**4 - 61710*f**5 - 43595*f**6 - 9660*f**7)/384384.,
    38: lambda f: (-117117 - 444444*f - 1161732*f**2 - 1672008*f**3 - 1279078*f**4 - 236480*f**5 + 463500*f**6 + 448840*f**7 + 173915*f**8 + 26460*f**9)/6.918912e6,
    39: lambda f: (117117 + 567138*f + 1954095*f**2 + 3995940*f**3 + 4492690*f**4 + 1928780*f**5 - 1069290*f**6 - 1621480*f**7 - 695660*f**8 - 105840*f**9)/5.5351296e7,
    40: lambda f: (-117117 - 689832*f - 2947230*f**2 - 7771764*f**3 - 10582495*f**4 - 5587700*f**5 + 2019300*f**6 + 3908800*f**7 + 1739150*f**8 + 264600*f**9)/5.5351296e8,
    41: lambda f: (117117 + 812526*f + 4141137*f**2 + 13344240*f**3 + 20438033*f**4 + 11909170*f**5 - 3384675*f**6 - 7672700*f**7 - 3478300*f**8 - 529200*f**9)/6.64215552e9,
    42: lambda f: 0,
}
...
Q000 = {
    ...
    13: lambda f: 0,
    14: lambda f: (-3 + 2*f - f**2)/18.,
    15: lambda f: (15 - 10*f + 2*f**2)/45.,
    16: lambda f: 0,
    17: lambda f: (15 - 2*f**2 + 3*f**4)/180.,
    18: lambda f: (-105 + 35*f**2 + 18*f**3 - 12*f**4)/630.,
    19: lambda f: 0,
    ...
    22: lambda f: 0,
    23: lambda f: (315 + 420*f + 420*f**2 + 36*f**3 - 182*f**4 - 20*f**5 + 180*f**6 + 140*f**7 + 35*f**8)/90720.,
    24: lambda f: (-3465 - 4620*f - 3927*f**2 + 1386*f**3 + 4873*f**4 + 3040*f**5 - 225*f**6 - 910*f**7 - 280*f**8)/498960.,
    25: lambda f: 0,
    26: lambda f: (-315 - 630*f - 1029*f**2 - 792*f**3 + 530*f**4 + 620*f**5 - 450*f**6 - 560*f**7 - 140*f**8)/725760.,
    27: lambda f: (3465 + 6930*f + 10626*f**2 + 6336*f**3 - 10978*f**4 - 14140*f**5 - 1080*f**6 + 3640*f**7 + 1120*f**8)/3.99168e6,
    28: lambda f: 0,
    29: lambda f: (63 + 168*f + 378*f**2 + 504*f**3 - 211*f**4 - 400*f**5 + 180*f**6 + 280*f**7 + 70*f**8)/1.45152e6,
    30: lambda f: (-3465 - 9240*f - 20097*f**2 - 24750*f**3 + 19690*f**4 + 37000*f**5 + 4350*f**6 - 9100*f**7 - 2800*f**8)/3.99168e7,
    31: lambda f: 0,
    32: lambda f: (-315 - 1050*f - 3003*f**2 - 5580*f**3 + 1777*f**4 + 4450*f**5 - 1575*f**6 - 2800*f**7 - 700*f**8)/8.70912e7,
    33: lambda f: (3465 + 11550*f + 32340*f**2 + 57816*f**3 - 31229*f**4 - 75650*f**5 - 10350*f**6 + 18200*f**7 + 5600*f**8)/4.790016e8,
    34: lambda f: 0,
    35: lambda f: 0,
    36: lambda f: 0,
    37: lambda f: 0,
...
Q002 = {
    ...
    14: lambda f: ((-2 + f)*f)/45.,
    15: lambda f: ((28 - 11*f)*f)/315.,
    16: lambda f: 0,
    17: lambda f: (f*(350 + 159*f - 36*f**2 - 84*f**3))/12600.,
    18: lambda f: (f*(98 - 273*f - 72*f**2 + 132*f**3))/8820.,
    19: lambda f: (f*(-490 + 259*f + 124*f**2 - 64*f**3))/29400.,
    ...
    23: lambda f: (f*(16170 + 36861*f + 46596*f**2 + 27034*f**3 - 1370*f**4 - 12675*f**5 - 7420*f**6 - 1540*f**7))/9.9792e6,
    24: lambda f: (f*(35574 + 45969*f + 11352*f**2 - 26882*f**3 - 18950*f**4 + 6585*f**5 + 10640*f**6 + 3080*f**7))/6.98544e6,
    25: lambda f: -(f*(210210 + 249249*f + 26884*f**2 - 218634*f**3 - 171330*f**4 - 5575*f**5 + 42420*f**6 + 13440*f**7))/1.009008e8,
    26: lambda f: (f*(-4620 - 14652*f - 27192*f**2 - 27133*f**3 - 6550*f**4 + 9705*f**5 + 7420*f**6 + 1540*f**7))/1.99584e7,
    27: lambda f: -(f*(25872 + 57519*f + 59928*f**2 - 24658*f**3 - 53740*f**4 + 2280*f**5 + 21280*f**6 + 6160*f**7))/2.794176e7,
    28: lambda f: (f*(70070 + 143143*f + 122408*f**2 - 116623*f**3 - 186150*f**4 - 24295*f**5 + 42420*f**6 + 13440*f**7))/2.018016e8,
    29: lambda f: (f*(4158 + 16863*f + 41052*f**2 + 53408*f**3 + 18380*f**4 - 17430*f**5 - 14840*f**6 - 3080*f**7))/1.596672e8,
    30: lambda f: (f*(67914 + 211827*f + 357720*f**2 - 67520*f**3 - 295100*f**4 - 6750*f**5 + 106400*f**6 + 30800*f**7))/5.588352e8,
    31: lambda f: -(f*(70070 + 203203*f + 302588*f**2 - 162188*f**3 - 382180*f**4 - 61070*f**5 + 84840*f**6 + 26880*f**7))/1.6144128e9,
    32: lambda f: (f*(-11550 - 56991*f - 171336*f**2 - 263509*f**3 - 105100*f**4 + 82200*f**5 + 74200*f**6 + 15400*f**7))/4.790016e9,
    33: lambda f: -(f*(42042 + 168168*f + 385572*f**2 - 37457*f**3 - 308300*f**4 - 15825*f**5 + 106400*f**6 + 30800*f**7))/3.3530112e9,
    34: lambda f: (f*(210210 + 789789*f + 1648504*f**2 - 628719*f**3 - 1935600*f**4 - 336550*f**5 + 424200*f**6 + 134400*f**7))/4.8432384e10,
    35: lambda f: (f*(-182 - 19*f + 36*f**2))/840.,
    36: lambda f: (f*(182 + 175*f + 40*f**2 - 41*f**3 - 20*f**4))/1680.,
    37: lambda f: (f*(-6006 - 10923*f - 9548*f**2 - 2514*f**3 + 2070*f**4 + 1805*f**5 + 420*f**6))/221760.,
    38: lambda f: (f*(2002 + 5357*f + 7832*f**2 + 3867*f**3 - 1410*f**4 - 1805*f**5 - 420*f**6))/443520.,
    39: lambda f: (f*(-2002 - 7073*f - 14388*f**2 - 8636*f**3 + 2380*f**4 + 3610*f**5 + 840*f**6))/3.54816e6,
    40: lambda f: (f*(6006 + 26367*f + 68552*f**2 + 45435*f**3 - 10800*f**4 - 18050*f**5 - 4200*f**6))/1.064448e8,
    41: lambda f: (f*(-2002 - 10505*f - 33220*f**2 - 23394*f**3 + 5070*f**4 + 9025*f**5 + 2100*f**6))/4.257792e8,
    42: lambda f: 0,
}
Q020 = {
    0: lambda f: -(f*(2 + f))/3.,
    ...
    13: lambda f: 0,
    14: lambda f: -((-2 + f)*f)/9.,
    15: lambda f: (f*(-28 + 11*f))/63.,
    16: lambda f: 0,
    17: lambda f: (f**2*(-5 + 3*f**2))/63.,
    18: lambda f: (f**2*(23 + 6*f - 9*f**2))/126.,
    19: lambda f: 0,
    20: lambda f: (f*(-14 + 3*f + 16*f**2 + 2*f**3 - 10*f**4 - 5*f**5))/504.,
    21: lambda f: (f*(308 - 99*f - 484*f**2 - 210*f**3 + 120*f**4 + 85*f**5))/5544.,
    22: lambda f: 0,
    23: lambda f: (f*(231 + 231*f - 66*f**2 - 263*f**3 - 65*f**4 + 165*f**5 + 140*f**6 + 35*f**7))/24948.,
    24: lambda f: -(f*(24024 + 22737*f - 14586*f**2 - 42913*f**3 - 24340*f**4 + 5415*f**5 + 10150*f**6 + 2905*f**7))/1.297296e6,
    25: lambda f: 0,
    26: lambda f: -(f*(1386 + 2739*f + 2112*f**2 - 3020*f**3 - 3020*f**4 + 1650*f**5 + 2240*f**6 + 560*f**7))/798336.,
    27: lambda f: (f*(36036 + 69927*f + 44616*f**2 - 107068*f**3 - 125440*f**4 + 1770*f**5 + 40600*f**6 + 11620*f**7))/1.0378368e7,
    28: lambda f: 0,
    29: lambda f: (f*(924 + 2673*f + 3960*f**2 - 3115*f**3 - 4600*f**4 + 1650*f**5 + 2800*f**6 + 700*f**7))/3.99168e6,
    30: lambda f: -(f*(48048 + 137709*f + 193050*f**2 - 207415*f**3 - 337000*f**4 - 12150*f**5 + 101500*f**6 + 29050*f**7))/1.0378368e8,
    31: lambda f: 0,
    32: lambda f: -(f*(2310 + 8745*f + 18480*f**2 - 10942*f**3 - 20050*f**4 + 5775*f**5 + 11200*f**6 + 2800*f**7))/9.580032e7,
    33: lambda f: (f*(60060 + 226083*f + 465036*f**2 - 350714*f**3 - 697400*f**4 - 40875*f**5 + 203000*f**6 + 58100*f**7))/1.24540416e9,
    34: lambda f: 0,
    35: lambda f: 0,
    36: lambda f: 0,
    37: lambda f: 0,
...
Q022 = {
    ...
    14: lambda f: -0.041666666666666664 - (29*f)/630. + (2*f**2)/45.,
    15: lambda f: (-735 + 616*f - 242*f**2)/1764.,
    16: lambda f: 0.125 - (9*f)/70. + (8*f**2)/245.,
    17: lambda f: (105 + 226*f + 159*f**2 - 84*f**3 - 96*f**4)/5040.,
    18: lambda f: (735 + 154*f - 381*f**2 - 108*f**3 + 198*f**4)/3528.,
    19: lambda f: (-8085 - 154*f + 6589*f**2 + 2116*f**3 - 2176*f**4)/129360.,
    ...
    23: lambda f: (45045 + 191334*f + 532389*f**2 + 696072*f**3 + 395423*f**4 - 84250*f**5 - 260265*f**6 - 145460*f**7 - 29120*f**8)/5.189184e7,
    24: lambda f: (315315 + 726726*f + 923637*f**2 + 183144*f**3 - 601429*f**4 - 426490*f**5 + 125655*f**6 + 220780*f**7 + 63910*f**8)/3.6324288e7,
    25: lambda f: (-105105 - 222222*f - 228657*f**2 + 128024*f**3 + 418221*f**4 + 254130*f**5 - 39035*f**6 - 93660*f**7 - 26880*f**8)/4.036032e7,
    26: lambda f: (-45045 - 238524*f - 880308*f**2 - 1729416*f**3 - 1739174*f**4 - 266720*f**5 + 835140*f**6 + 581840*f**7 + 116480*f**8)/4.1513472e8,
    27: lambda f: (-315315 - 1057056*f - 2277990*f**2 - 2315352*f**3 + 1191022*f**4 + 2342440*f**5 - 65040*f**6 - 883120*f**7 - 255640*f**8)/2.90594304e8,
    28: lambda f: (105105 + 332332*f + 656084*f**2 + 417768*f**3 - 1046738*f**4 - 1236960*f**5 - 10900*f**6 + 374640*f**7 + 107520*f**8)/3.2288256e8,
    29: lambda f: (45045 + 285714*f + 1305447*f**2 + 3384420*f**3 + 4410530*f**4 + 1169900*f**5 - 1916250*f**6 - 1454600*f**7 - 291200*f**8)/4.1513472e9,
    30: lambda f: (315315 + 1387386*f + 4172883*f**2 + 7030140*f**3 - 1823740*f**4 - 6386500*f**5 - 202050*f**6 + 2207800*f**7 + 639100*f**8)/2.90594304e9,
    31: lambda f: (-105105 - 442442*f - 1263691*f**2 - 1773460*f**3 + 2047910*f**4 + 3276100*f**5 + 166450*f**6 - 936600*f**7 - 268800*f**8)/3.2288256e9,
    32: lambda f: (-45045 - 332904*f - 1807806*f**2 - 5793684*f**3 - 8842471*f**4 - 2842900*f**5 + 3660900*f**6 + 2909200*f**7 + 582400*f**8)/4.98161664e10,
    33: lambda f: (-315315 - 1717716*f - 6608316*f**2 - 15255708*f**3 + 2408723*f**4 + 13303400*f**5 + 768750*f**6 - 4415600*f**7 - 1278200*f**8)/3.487131648e10,
    34: lambda f: (105105 + 552552*f + 2051478*f**2 + 4248452*f**3 - 3498597*f**4 - 6735900*f**5 - 472100*f**6 + 1873200*f**7 + 537600*f**8)/3.87459072e10,
    35: lambda f: (-273 - 178*f + 25*f**2 + 84*f**3)/336.,
    36: lambda f: (3003 + 5104*f + 4598*f**2 + 20*f**3 - 1993*f**4 - 820*f**5)/14784.,
    37: lambda f: (-39039 - 107250*f - 190047*f**2 - 151736*f**3 - 17373*f**4 + 61710*f**5 + 43595*f**6 + 9660*f**7)/1.153152e6,
    38: lambda f: (39039 + 148148*f + 387244*f**2 + 557336*f**3 + 224946*f**4 - 182880*f**5 - 174380*f**6 - 38640*f**7)/9.225216e6,
    39: lambda f: (-39039 - 189046*f - 651365*f**2 - 1331980*f**3 - 691910*f**4 + 403900*f**5 + 435950*f**6 + 96600*f**7)/9.225216e7,
    40: lambda f: (39039 + 229944*f + 982410*f**2 + 2590588*f**3 + 1513365*f**4 - 754500*f**5 - 871900*f**6 - 193200*f**7)/1.10702592e9,
    41: lambda f: (-39039 - 270842*f - 1380379*f**2 - 4448080*f**3 - 2784411*f**4 + 1264410*f**5 + 1525825*f**6 + 338100*f**7)/1.549836288e10,
    42: lambda f: 1.625 - (9*f)/14.,
}
...
class Common(object):
    def __init__(self, Nl=2, kmin=0.001, kmax=0.5):
        ...
        self.sresum = np.concatenate([[self.sMin-.2, self.sMin-.1, self.sMin], self.sbao, [self.sMax-1., self.sMax, self.sMax+10.]])
...
class Resum(object):
    def __init__(self, co=common, LambdaIR=0.12, NFFT=128):
        self.LambdaIR = LambdaIR
        
        self.NIR = 35 # 24: 4 IR-corrections (only in l=2) that are sub-leading (no)
        ...
        self.fftsettings = dict(Nmax=NFFT, xmin=co.sresum[0], xmax=co.sresum[-1]-1., bias=0.3)
        self.fft = FFTLog(**self.fftsettings)
        self.setM(co=co)
        self.setkPow()
        ...
        k2pi = np.array([co.kr**2, co.kr**4, co.kr**6, co.kr**8, co.kr**10, co.kr**12, co.kr**14])
        self.k2p = np.concatenate((k2pi, k2pi, k2pi))
    
    def setXsPow(self, co=common):
        self.XsPow = np.exp(np.einsum('n,s->ns', -self.Xfft.Pow-3., np.log(co.sresum)))
    ...
    def IRCorrection(self, XpYpC, k2p, lpr=None, co=common):
        Coef = self.fft.Coef(co.sresum, XpYpC, window=1)
    ...
    def Ps(self, bird, full=True, co=common):
        ...
        Xp = np.array([X, X**2, X**3, X**4, X**5, X**6, X**7])
        ### This guys below also don't think to make a difference??? ### TO CHECK
        XpY = np.array([Y, X*Y, X**2*Y, X**3*Y, X**4*Y, X**5*Y, X**6*Y])
        ### This guys below are only for l=2 and they seem to make no difference.
        ...
        if full is True:
            for a, cf in enumerate(bird.Cf):
                ...
                for l, cl in enumerate(cbao):
                    u = 0
                    for j, (xy, k2pj, lpr) in enumerate(zip(XpYp, self.k2p, alllpr)):
